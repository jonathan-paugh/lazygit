...
func (self *FilesController) GetKeybindings(opts types.KeybindingsOpts) []*types.Binding {
	return []*types.Binding{
		...
		},
		{
			...
			Handler:     opts.Guards.OutsideStagingMode(self.handleAmendCommitPress),
		...
		},
		{
			...
			Handler:           opts.Guards.OutsideStagingMode(self.withItem(self.ignoreOrExcludeMenu)),
			GetDisabledReason: self.require(self.singleItemSelected()),
		...
		},
		{
			...
			Handler:               opts.Guards.OutsideStagingMode(self.stash),
		...
		},
		{
			...
			Handler:     opts.Guards.OutsideStagingMode(self.createStashMenu),
		...
		},
		{
			...
			Handler:               opts.Guards.OutsideStagingMode(self.withItems(self.remove)),
		...
		},
		{
			...
			Handler:     opts.Guards.OutsideStagingMode(self.createResetToUpstreamMenu),
			Description: self.c.Tr.ViewResetToUpstreamOptions,
			OpensMenu:   true,
		},
		{
			Key:                   opts.GetKey(opts.Config.Files.ViewResetOptions),
			Handler:               opts.Guards.OutsideStagingMode(self.createResetMenu),
		...
		},
		{
			...
			Handler:               opts.Guards.OutsideStagingMode(self.withItems(self.openMergeConflictMenu)),
		...
		},
		{
			...
			Handler:     opts.Guards.OutsideStagingMode(self.fetch),
